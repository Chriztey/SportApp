...
fun SportsApp(
    ...
    val sportsContentType: SportsContentType = when (windowSize) {
    ...
    Scaffold(
        topBar = {
            SportsAppBar(
                ...
                onBackButtonClick = {
                    if (sportsContentType == SportsContentType.ListOnly) {viewModel.navigateToListPage() }
        ...
        if (sportsContentType == SportsContentType.ListAndDetail) {
